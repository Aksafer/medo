...
async def init():
    ...
    LOGGER("ميــوزك ايـرور").info("TmLotus")
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("ميــوزك ايـرور").info("جارِ ايقاف بوت الميوزك . . .")
