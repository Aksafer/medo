...
async def get_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("MatrixMusic/assets/circle.png")
            ...
            image4.text((10, 10), "𝐼𝑺 𝑃𝐼𝐷𝐸𝑅 𝑀𝑈𝑺𝐼𝐶", fill="white", font = font1, align ="left") 
            image4.text((670, 150), "𝐼𝑺 𝑃𝐼𝐷𝐸𝑅 𝑃𝐿𝐴𝑌𝐼𝑁𝐺", fill="white", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
