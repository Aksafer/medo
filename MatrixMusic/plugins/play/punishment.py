...
from MatrixMusic.filters import command, other_filters
from MatrixMusic.filters import omar, other_filters
from MatrixMusic.decorators import bot_creator
from MatrixMusic.database.dbchat import get_served_chats
from MatrixMusic.database.dbpunish import add_gban_user, is_gbanned_user, remove_gban_user

from config import OWNER_ID, SUDO_USERS, BOT_USERNAME as bn


@Client.on_message(omar(["gban", f"gban@{bn}","حظر","/gban"]) & other_filters)
@bot_creator
...
@Client.on_message(omar(["ungban", f"ungban@{bn}","الغاء الحظر","/ungban"]) & other_filters)
@bot_creator
