...
※ استخدم الازرار لمعرفه الاوامر المستخدمه. """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("᥉᥆ᥙᖇᥴᥱ ᥉᥆ꪔ3ᥲ", url=f"https://t.me/SOURCE_SOM3A"),
...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="afyona"),
                ...
                [
                    InlineKeyboardButton(
                        "‹ السورس ›", url=f"https://t.me/SOURCE_SOM3A"
                    ),
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="SOURCE_SOM3A"),
                ],
                [                
                    InlineKeyboardButton(" Commands", callback_data="cbcmds"),
                    InlineKeyboardButton(" Donate ", url=f"https://t.me/SOURCE_SOM3A"),
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "‹ المطور ›", url=f"https://t.me/Y_D_ll"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
@Client.on_callback_query(filters.regex("SOURCE_SOM3A"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""**※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخرى يمكنك التواصل مع المطور من هنا : @Y_D_ll **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
