...
from MatrixMusic.filters import omar, other_filters
from MatrixMusic.decorators import bot_creator, sudo_users_only
from MatrixMusic.database.dbchat import get_served_chats
from MatrixMusic.database.dbusers import get_served_users
from MatrixMusic.database.dbpunish import get_gbans_count
from MatrixMusic.database.dbqueue import get_active_chats

from config import BOT_USERNAME as uname


@Client.on_message(omar(["/broadcast", f"/broadcast@{uname}","اذاعه"]) & ~filters.edited)
@bot_creator
...
@Client.on_message(omar(["/broadcast_pin", f"/broadcast_pin@{uname}","بالتثبيت","ذيع"]) & ~filters.edited)
@bot_creator
...
@Client.on_message(omar(["/stats", f"/stats@{uname}","الاحصائيات"]) & ~filters.edited)
@sudo_users_only
